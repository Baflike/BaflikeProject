$(document).ready(function () {
  ...
  $(".change_point_header img").click(function() {
    if ($(".change_point_header_minus").css("display") === "block") {
      $(".change_point_header_minus").css("display", "none");
      $(".change_point_header_plus").css("display", "block");
      $(".change_point_footer").css("display", "none");
    } else {
      $(".change_point_header_minus").css("display", "block");
      $(".change_point_header_plus").css("display", "none");
      $(".change_point_footer").css("display", "block");
    }
  });

  $(".statistic_header img").click(function() {
    if ($(".statistic_header_minus").css("display") === "block") {
      $(".statistic_header_minus").css("display", "none");
      $(".statistic_header_plus").css("display", "block");
      $(".statistic_footer").css("display", "none");
      $(".statistic_table").css("display", "none");
    } else {
      $(".statistic_header_minus").css("display", "block");
      $(".statistic_header_plus").css("display", "none");
      $(".statistic_footer").css("display", "block");
      $(".statistic_table").css("display", "block");
  ...
  $(".right-panel-link-item button").click(function () {
    ...
    $("[data-righttabcontent='" + leftpanel_id + "']").addClass(
  ...
  $(".ads-tablink").click(function () {
    ...
    $(this)
      .closest(".ads-tab")
      .children(".ads-tablink")
      .removeClass("ads-tablink-active");
    $(this)
      .closest(".ads-tab")
      .children("[data-bftab='" + statistic_id + "']")
      .addClass("ads-tablink-active");
    $(this)
      .closest(".ads-statistic-content")
      .children(".ads-statistic-info")
      .removeClass("statistic-active");
    $(this)
      .closest(".ads-statistic-content")
      .children("[data-bfid='" + statistic_id + "']")
      .addClass("statistic-active");
  });
  // statistic info end
  ...
  $(".ranking-tab-people").prepend(
    '<ul class="ranking-tab-number ranking-number-people"></ul>'
  );
  $(".ranking-tab-earn").prepend(
    '<ul class="ranking-tab-number ranking-number-earn"></ul>'
  );
  ...
  for (i = 1; i <= raniking_people_numbersize; i++) {
    if (i > 0 && i < 4) {
      $(".ranking-number-people").append(
        '<li class="ranking-number-item" style="background-color: rgba(118, 151, 243, 0.2);">' +
        i +
        "</li>"
      );
    } else if (i > 3 && i < 9) {
      $(".ranking-number-people").append(
        '<li class="ranking-number-item" style="background-color: rgba(251, 31, 31, 0.2);">' +
        i +
        "</li>"
      );
    } else {
      $(".ranking-number-people").append(
        '<li class="ranking-number-item" style="background-color: rgba(27, 172, 11, 0.2);">' +
        i +
        "</li>"
      );
    }
  ...
  // //    message box bottom scroll starting - start

  var myDiv = document.querySelector(".popup-messagebox-box-center");
  myDiv.scrollTop = myDiv.scrollHeight;

  // //    message box bottom scroll starting - end
  ...
  $(".profile-panel-left button").click(function () {
    ...
    $("[data-profilecontent='" + data_profilebtndata + "']").addClass(
  ...
  $(".profile-follow-list-buttons button").click(function () {
    ...
    $("[data-profilecontent='" + data_profilebtndata + "']").addClass(
      "profile-follow-list-tab-active"
    );
  });
  ...
  $(".header-web-button").click(function () {
    ...
    if (checked_class_profile_icon == true) {
      ...
      checked_class_header_icon == true &&
      checked_class_arrow == true
    ) {
  ...
  $(".header-web-button").click(function () {
    ...
    if (
      $("[data-contentmenu='" + webButtonData + "']").hasClass(
        "data-web-menu-none"
      )
    ) {
      $(".data-panel-web-menu").addClass("data-web-menu-none");
      $("[data-contentmenu='" + webButtonData + "']").removeClass(
        "data-web-menu-none"
      );
    } else {
      $(".data-panel-web-menu").addClass("data-web-menu-none");
  ...
  $(".header-mobile-button").click(function () {
    ...
    if (
      $("[data-contentmenu='" + mobilButtonData + "']").hasClass(
        "data-menu-none"
      )
    ) {
      $(".data-panel-menu").addClass("data-menu-none");
      $("[data-contentmenu='" + mobilButtonData + "']").removeClass(
        "data-menu-none"
      );
...
document.querySelector(".profile-image-big-overlay").addEventListener("click",change_profile_image);
function change_profile_image (){
  document.querySelector(".profile-image-big-overlay .profile-image-big-overlay-input").click();
}